...
export class DataService {
  ...
  private _countriesUrl = this._localhostUrl + '/countries/?format=json';
  private _initialDataUrl = this._localhostUrl + '/initialdata/?format=json';
  private _getDataUrl = this._localhostUrl + '/data'; //  /search/22/11/?countryIds=[1]&time=1950-200
